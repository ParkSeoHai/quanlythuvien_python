...
class Ctphieuhuys(models.Model):
    ...
    id_phieuhuy = models.ForeignKey('Phieuhuys', models.DO_NOTHING, db_column='id_phieuhuy')
...
class Ctphieunhaps(models.Model):
    ...
    id_phieunhap = models.ForeignKey('Phieunhaps', models.DO_NOTHING, db_column='id_phieunhap')
    id_sach = models.ForeignKey(Books, models.DO_NOTHING, db_column='id_sach')
    so_luong = models.IntegerField()
